...
<?php if ( have_posts() ) : while ( have_posts() ) : the_post(); ?>
        ...
        <div class="main_content_single">
                    <section class="introducao-interna interna">
                        <div class="container">
                            <h1 data-anime="400" class="uk-animation-fade"><?php get_field('titulo_vaga'); ?></h1>
                            <p data-anime="800" class="uk-animation-fade"><?php get_field('desc_vaga'); ?></p>
                        </div>
                    </section>
                    <form class="cadastro_vaga uk-animation-scale-down">
                        <fieldset class="uk-fieldset">
                    
                            <legend class="uk-legend">Cadindatar-se</legend>
